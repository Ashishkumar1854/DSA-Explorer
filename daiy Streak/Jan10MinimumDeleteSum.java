//dp question so learn concept and then sgain solve this 

import java.util.*;

public class Jan10MinimumDeleteSum {
  ...
  public static void main(String[] args) {
    ...
    Jan10MinimumDeleteSum obj = new Jan10MinimumDeleteSum();
    int ans = obj.minimumDeleteSum(s1, s2);

    System.out.println(ans); // Output: 231
  }
}
