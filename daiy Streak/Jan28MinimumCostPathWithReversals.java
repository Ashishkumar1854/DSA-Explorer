...
// copy phaste questions again solve with yt ,HARD level
import java.util.*;

public class Jan28MinimumCostPathWithReversals {
  ...
  public static void main(String[] args) {
    ...
    Jan28MinimumCostPathWithReversals obj = new Jan28MinimumCostPathWithReversals();
